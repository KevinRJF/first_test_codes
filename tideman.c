...
// definir el número máximo de candidatos
#define MAX 9

// preferences[i][j] es el número de votadores que prefieren i que j
...
// prototipos de función (son varios xd)
